...
<a href="https://render.com/deploy?repo=https://github.com/triggerdotdev-internal/basic-starter-public-1">
...
```sh
git clone https://github.com/triggerdotdev-internal/basic-starter-public-1.git
cd basic-starter-public-1
npm install
```
